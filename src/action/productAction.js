...
export const getProduct=(keyword="",currentPage=1)=>async(dispatch)=>{
    ...
    try{
        ...
        let link=`https://adhub.onrender.com/products`
        // console.log("curent",keyword)
        let key="";
        if('keyword' in keyword){
            key=keyword.keyword;
        }
        link=`https://adhub.onrender.com/products?keyword=${key}&page=${currentPage}`
...
export const getAdminProduct=(keyword="",currentPage=1)=>async(dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.get("https://adhub.onrender.com/admin/products");
        // console.log(data)
...
export const getProductDetails=(id)=>async(dispatch)=>{
    try {
        ...
        const {data} = await axios.get(`https://adhub.onrender.com/products/${id}`)
...
export const newReview=(reviewData)=>async (dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.put('https://adhub.onrender.com/review',reviewData,config);
...
export const createProduct=(productData)=>async (dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.post('https://adhub.onrender.com/admin/products/new',productData,config);
...
export const deleteProduct=(id)=>async (dispatch)=>{
    ...
    try{
        ...
        const {data} = await axios.delete(`https://adhub.onrender.com/admin/products/${id}`);
